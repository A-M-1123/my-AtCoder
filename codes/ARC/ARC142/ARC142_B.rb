...
if n % 2 == 0
  for i in 1..(n/2)
    if i % 2 == 1
      pos = n/2-i
      sts.push([[pos,pos], i*2, [1,0]])
      sts.push([[pos,pos+1], i*2-1, [0,1]])
    else
      pos = n/2+(i-1)
      sts.push([[pos,pos], i*2, [-1,0]])
      sts.push([[pos,pos-1], i*2-1, [0,-1]])
  ...
  while i > 0
    if i % 2 == 1
      pos = n/2+(i-1)
      sts.push([[pos,pos], i*2-1, [-1,0]])
      sts.push([[pos,pos-1], i*2-2, [0,-1]])
    else
      pos = n/2-i
      sts.push([[pos,pos], i*2-1, [1,0]])
      sts.push([[pos,pos+1], i*2-2, [0,1]])
  ...
  sts.push([[n/2,n/2], 1, [0,0]])

  for i in 2..(n/2+1)
    if i % 2 == 0
      pos = n/2-(i-1)
      sts.push([[pos,pos+1], (i-1)*2, [0,1]])
      sts.push([[pos+1,pos], (i-1)*2, [1,0]])
    else
      pos = n/2+(i-1)
      sts.push([[pos-1,pos], (i-1)*2, [-1,0]])
      sts.push([[pos,pos-1], (i-1)*2, [0,-1]])
  ...
  while i > 1
    if i % 2 == 0
      posOp = n/2-(i-1)
      pos = n/2+(i-1)
      sts.push([[posOp,posOp], 1, [0,0]])
      sts.push([[pos,pos], (i-1)*2, [0,-1]])
      sts.push([[pos-1, pos], (i-1)*2-1, [-1,0]])
    else
      posOp = n/2+(i-1)
      pos = n/2-(i-1)
      sts.push([[posOp,posOp], 1, [0,0]])
